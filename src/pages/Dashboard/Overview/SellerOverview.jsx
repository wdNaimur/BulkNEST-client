  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-base-200 shadow-xl shadow-primary/5 rounded-xl p-5">
          <p className="text-secondary/60">Total Orders</p>
          <h2 className="text-2xl font-bold mt-2">1,245</h2>
        </div>
        <div className="bg-base-200 shadow-xl shadow-primary/5 rounded-xl p-5">
          <p className="text-secondary/60">Revenue</p>
          <h2 className="text-2xl font-bold mt-2">$12,560</h2>
        </div>
        <div className="bg-base-200 shadow-xl shadow-primary/5 rounded-xl p-5">
          <p className="text-secondary/60">New Customers</p>
          <h2 className="text-2xl font-bold mt-2">320</h2>
        </div>
        <div className="bg-base-200 shadow-xl shadow-primary/5 rounded-xl p-5">
          <p className="text-secondary/60">Pending Orders</p>
      ...
      {/* Graph Section */}
      <div className="bg-base-200 shadow-xl shadow-primary/5 rounded-xl p-5">
        <p className="text-secondary/60 mb-4">Sales Overview</p>
        <div className="h-72">
