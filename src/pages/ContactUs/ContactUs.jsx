      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-xl shadow space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600">+880 1648560748</p>
          </div>

          <div>
            <h2 className="text-xl font-bold mb-2">Email</h2>
            <p className="text-gray-600">support@bulknest.com</p>
          </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="bg-primary text-white px-6 py-2 rounded-lg shadow hover:bg-secondary/90 transition cursor-pointer"
            >
              Send Message
            </button>
          </form>
