  ...
  return (
    <div className="p-6 bg-gradient-to-t from-base-100 to-base-200 lg:p-12 text-secondary">
      <div className=" space-y-12 container mx-auto">
        ...
        {!user && (
          <section className="bg-secondary text-white p-8 rounded-xl  shadow-xl shadow-primary/5 text-center mx-auto">
            ...
            <Link
              to={`/signIn`}
              className="bg-base-200 text-secondary font-semibold px-6 py-2 rounded-lg  shadow-xl shadow-primary/5 hover:bg-gray-100 transition"
            >
              Get Started
            </Link>
          </section>
